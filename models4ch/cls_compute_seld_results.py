...
class ComputeSELDResults(object):
    def __init__(
            self, params, ref_files_folder=None, use_polar_format=False
    ):
...
if __name__ == "__main__":
    pred_output_format_files = 'results/6_1_dev_split0_multiaccdoa_mic_gcc_20230909122243_test' # Path of the DCASEoutput format files
